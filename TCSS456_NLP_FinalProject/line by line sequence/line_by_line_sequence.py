...
# evaluate model
print(generate_seq(model, tokenizer, max_length-1, 'would' ,200))
print(generate_seq(model, tokenizer, max_length-1, 'hurt' , 200))
print(generate_seq(model, tokenizer, max_length-1, 'type' , 200))
print(generate_seq(model, tokenizer, max_length-1, 'sending' , 200))